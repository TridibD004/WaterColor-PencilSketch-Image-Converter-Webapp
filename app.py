"""
 Real Image to Pencil Sketch or Water Color Sketch Converter
 @author: Tridib Dalui
"""
...
def main():
	...
	st.title('StreamLit APPLICATION TO CONVERT IMAGE TO SKETCH')
	st.write("This is an application developed for converting\
	your ***image*** to a ***Water Color Image*** OR ***Pencil Sketch***")
